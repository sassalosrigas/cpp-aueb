...
HealthBar::HealthBar(float maxHealth) : m_maxHealth(maxHealth), m_currentHealth(maxHealth) {
    ...
    m_healthBarBrush.texture = m_state->getFullAssetPath("healthbar_full.png");
}
